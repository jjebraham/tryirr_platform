# Generated by Django 5.2.4 on 2025-07-25 20:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_document', models.FileField(blank=True, help_text='A scan or photo of your government‑issued ID.', null=True, upload_to='kyc/id_documents/')),
                ('selfie', models.FileField(blank=True, help_text='A selfie of you holding your ID next to your face.', null=True, upload_to='kyc/selfies/')),
                ...
                ('address_document', models.FileField(blank=True, null=True, upload_to='kyc/address/')),
                ('deposit_proof', models.FileField(blank=True, null=True, upload_to='kyc/deposit/')),
